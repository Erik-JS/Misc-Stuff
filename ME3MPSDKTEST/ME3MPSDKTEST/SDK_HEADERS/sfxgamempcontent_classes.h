...
// Class sfxgamempcontent.sfxpowercustomactionmp_bioticcharge
// 0x0007 (0x08B4 - 0x08AD)
class Usfxpowercustomactionmp_bioticcharge : public Usfxpowercustomaction_bioticcharge
{
public:
	float                                              ChargeSpeedMultiplier;                            		// 0x08B0 (0x0004) [0x0000000000000000]              
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 135929 ];
...
UClass* Usfxpowercustomactionmp_bioticcharge::pClassPointer = NULL;

// Class sfxgamempcontent.SFXCameraMode_DrellRollLateral
// 0x0000 (0x00F0 - 0x00F0)
class USFXCameraMode_DrellRollLateral : public USFXCameraMode_Combat
{
public:
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 136030 ];
...
UClass* USFXCameraMode_DrellRollLateral::pClassPointer = NULL;

// Class sfxgamempcontent.SFXPawn_PlayerMP_Vanguard
// 0x0000 (0x1288 - 0x1288)
class ASFXPawn_PlayerMP_Vanguard : public Asfxpawn_playermp
{
public:
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 136124 ];
...
UClass* ASFXPawn_PlayerMP_Vanguard::pClassPointer = NULL;
