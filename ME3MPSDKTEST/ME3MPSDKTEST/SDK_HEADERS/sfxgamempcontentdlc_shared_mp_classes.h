...
// Class sfxgamempcontentdlc_shared_mp.SFXGameEffect_CappedDamageReduction
// 0x0012 (0x0074 - 0x0062)
class USFXGameEffect_CappedDamageReduction : public USFXGameEffect
{
public:
	float                                              MinDamageReduction;                               		// 0x0064 (0x0004) [0x0000000000000000]              
	float                                              DesiredDamageReduction;                           		// 0x0068 (0x0004) [0x0000000000000000]              
	class Usfxmodule_damage*                           CachedDmgModule;                                  		// 0x006C (0x0004) [0x0000000000000000]              
	float                                              UpdateFrequency;                                  		// 0x0070 (0x0004) [0x0000000000004000]              ( CPF_Config )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 136285 ];
...
UClass* USFXGameEffect_CappedDamageReduction::pClassPointer = NULL;
