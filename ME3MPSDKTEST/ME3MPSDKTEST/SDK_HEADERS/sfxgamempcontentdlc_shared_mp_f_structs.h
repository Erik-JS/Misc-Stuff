...
// [0x00020802] ( FUNC_Event )
struct USFXGameEffect_CappedDamageReduction_eventOnRemoved_Parms
{
};

// Function sfxgamempcontentdlc_shared_mp.SFXGameEffect_CappedDamageReduction.UpdateBonus
// [0x00020003] ( FUNC_Final )
struct USFXGameEffect_CappedDamageReduction_execUpdateBonus_Parms
{
	// float                                           fDesiredBonus;                                    		// 0x0000 (0x0004) [0x0000000000000000]              
	// float                                           fAmountOver;                                      		// 0x0004 (0x0004) [0x0000000000000000]              
};

// Function sfxgamempcontentdlc_shared_mp.SFXGameEffect_CappedDamageReduction.OnApplied
// [0x00020002] 
struct USFXGameEffect_CappedDamageReduction_execOnApplied_Parms
{
};
