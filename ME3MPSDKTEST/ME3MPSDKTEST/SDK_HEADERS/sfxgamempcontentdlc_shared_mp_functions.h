...
// Function sfxgamempcontentdlc_shared_mp.SFXGameEffect_CappedDamageReduction.OnRemoved
// [0x00020802] ( FUNC_Event )
// Parameters infos:

void USFXGameEffect_CappedDamageReduction::eventOnRemoved ( )
{
	static UFunction* pFnOnRemoved = NULL;

	if ( ! pFnOnRemoved )
		pFnOnRemoved = (UFunction*) UObject::GObjObjects()->Data[ 136360 ];

	USFXGameEffect_CappedDamageReduction_eventOnRemoved_Parms OnRemoved_Parms;

	this->ProcessEvent ( pFnOnRemoved, &OnRemoved_Parms, NULL );
};

// Function sfxgamempcontentdlc_shared_mp.SFXGameEffect_CappedDamageReduction.UpdateBonus
// [0x00020003] ( FUNC_Final )
// Parameters infos:

void USFXGameEffect_CappedDamageReduction::UpdateBonus ( )
{
	static UFunction* pFnUpdateBonus = NULL;

	if ( ! pFnUpdateBonus )
		pFnUpdateBonus = (UFunction*) UObject::GObjObjects()->Data[ 136356 ];

	USFXGameEffect_CappedDamageReduction_execUpdateBonus_Parms UpdateBonus_Parms;

	this->ProcessEvent ( pFnUpdateBonus, &UpdateBonus_Parms, NULL );
};

// Function sfxgamempcontentdlc_shared_mp.SFXGameEffect_CappedDamageReduction.OnApplied
// [0x00020002] 
// Parameters infos:

void USFXGameEffect_CappedDamageReduction::OnApplied ( )
{
	static UFunction* pFnOnApplied = NULL;

	if ( ! pFnOnApplied )
		pFnOnApplied = (UFunction*) UObject::GObjObjects()->Data[ 136353 ];

	USFXGameEffect_CappedDamageReduction_execOnApplied_Parms OnApplied_Parms;
