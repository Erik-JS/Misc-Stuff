...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 135565 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 135568 ];
...
UClass* USFXDamageType_BioticCharge::pClassPointer = NULL;
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 135571 ];
...
UClass* USFXDamageType_BioticCharge_NoRagdoll::pClassPointer = NULL;
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 135574 ];
...
// Class sfxgamecontent.SFXGameEffect_Cloak
// 0x0026 (0x0088 - 0x0062)
class USFXGameEffect_Cloak : public USFXGameEffect
{
public:
	struct FScriptDelegate                             __OnCloakEnded__Delegate;                         		// 0x0064 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FGuid                                       CloakEffectGuid;                                  		// 0x0070 (0x0010) [0x0000000000000000]              
	class URvrClientEffectInterface*                   CE_CloakEffect;                                   		// 0x0080 (0x0004) [0x0000000000000000]              
	float                                              CloakTimer;                                       		// 0x0084 (0x0004) [0x0000000000000000]              
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 135577 ];
	...
	void TurnVFXOn ( );
	void OnApplied ( );
	void OnCloakEnded ( float TimeInCloak );
};

UClass* USFXGameEffect_Cloak::pClassPointer = NULL;
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 135603 ];
...
// 0x0218 (0x08AD - 0x0695)
class Usfxpowercustomaction_bioticcharge : public Usfxpowercustomaction
{
public:
	struct FPowerData                                  DamageReduction;                                  		// 0x0698 (0x0030) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FPowerData                                  DamageReductionDuration;                          		// 0x06C8 (0x0030) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FPowerData                                  ShieldsRestored;                                  		// 0x06F8 (0x0030) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FInterpCurveFloat                           TimeCurve;                                        		// 0x0728 (0x0010) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	struct FString                                     FailedLineCheckName;                              		// 0x0738 (0x000C) [0x0000000000402001]              ( CPF_Edit | CPF_Transient | CPF_NeedCtorLink )
	TArray< struct FCharge_PendingVolume >             VolumeList;                                       		// 0x0744 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	class UClass*                                      CustomDetonationRumbleClass;                      		// 0x0750 (0x0004) [0x0000000000000000]              
	class UClass*                                      CustomDetonationScreenShakeClass;                 		// 0x0754 (0x0004) [0x0000000000000000]              
	struct FScreenShakeStruct                          HitShake;                                         		// 0x0758 (0x0078) [0x0000000000000001]              ( CPF_Edit )
	struct FVector                                     CachedTeleportLocation;                           		// 0x07D0 (0x000C) [0x0000000000002001]              ( CPF_Edit | CPF_Transient )
	struct FVector                                     CachedTargetLocation;                             		// 0x07DC (0x000C) [0x0000000000002001]              ( CPF_Edit | CPF_Transient )
	struct FVector                                     CachedStartingLocation;                           		// 0x07E8 (0x000C) [0x0000000000002001]              ( CPF_Edit | CPF_Transient )
	struct FVector                                     FailedLineCheckStart;                             		// 0x07F4 (0x000C) [0x0000000000002001]              ( CPF_Edit | CPF_Transient )
	struct FVector                                     FailedLineCheckEnd;                               		// 0x0800 (0x000C) [0x0000000000002001]              ( CPF_Edit | CPF_Transient )
	struct FName                                       BonusName;                                        		// 0x080C (0x0008) [0x0000000000000000]              
	float                                              StingerDuration;                                  		// 0x0814 (0x0004) [0x0000000000004000]              ( CPF_Config )
	float                                              StingerSlowPct;                                   		// 0x0818 (0x0004) [0x0000000000004000]              ( CPF_Config )
	float                                              FrozenTargetForceMult;                            		// 0x081C (0x0004) [0x0000000000004000]              ( CPF_Config )
	float                                              ConeAngle;                                        		// 0x0820 (0x0004) [0x0000000000004000]              ( CPF_Config )
	float                                              CooldownBonusFromMelee;                           		// 0x0824 (0x0004) [0x0000000000004000]              ( CPF_Config )
	float                                              CooldownDurationFromMelee;                        		// 0x0828 (0x0004) [0x0000000000004000]              ( CPF_Config )
	float                                              Evolve_DamageForceBonus;                          		// 0x082C (0x0004) [0x0000000000004000]              ( CPF_Config )
	float                                              Evolve_ImpactRadiusBonus;                         		// 0x0830 (0x0004) [0x0000000000004000]              ( CPF_Config )
	float                                              Evolve_MaxImpactTargetsBonus;                     		// 0x0834 (0x0004) [0x0000000000004000]              ( CPF_Config )
	float                                              Evolve_TimedWeaponDamageBonus;                    		// 0x0838 (0x0004) [0x0000000000004000]              ( CPF_Config )
	float                                              Evolve_TimedWeaponDamageDuration;                 		// 0x083C (0x0004) [0x0000000000004000]              ( CPF_Config )
	float                                              Evolve_TimedPowerDamageBonus;                     		// 0x0840 (0x0004) [0x0000000000004000]              ( CPF_Config )
	float                                              Evolve_TimedPowerDamageDuration;                  		// 0x0844 (0x0004) [0x0000000000004000]              ( CPF_Config )
	float                                              Evolve_NoCooldownChance;                          		// 0x0848 (0x0004) [0x0000000000004000]              ( CPF_Config )
	float                                              Evolve_ShieldRestoredBonus;                       		// 0x084C (0x0004) [0x0000000000004000]              ( CPF_Config )
	class APawn*                                       CachedTarget;                                     		// 0x0850 (0x0004) [0x0000000000002001]              ( CPF_Edit | CPF_Transient )
	float                                              TeleportStartDelay;                               		// 0x0854 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              TeleportDelay;                                    		// 0x0858 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              ImpactDelay;                                      		// 0x085C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              ImpactDelay_Min;                                  		// 0x0860 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              ImpactDelay_Max;                                  		// 0x0864 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              TimeStingerDelay;                                 		// 0x0868 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              CounterTimeScaleValue;                            		// 0x086C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              CameraImpactDelay;                                		// 0x0870 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	class UParticleSystem*                             PS_TeleportIn;                                    		// 0x0874 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	class UParticleSystem*                             PS_TeleportOut;                                   		// 0x0878 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	class URvrClientEffectInterface*                   CE_CrustEffect;                                   		// 0x087C (0x0004) [0x0000000000000000]              
	class URvrClientEffectInterface*                   CE_ChargeImpact;                                  		// 0x0880 (0x0004) [0x0000000000000000]              
	class ASFXProjectile_Power_BioticCharge*           ChargeProjectile;                                 		// 0x0884 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	class USFXCameraTransition_VanguardSlam*           CamTransition;                                    		// 0x0888 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	class UForceFeedbackWaveform*                      HitForceFeedback;                                 		// 0x088C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	class UWwiseEvent*                                 ChargeCast;                                       		// 0x0890 (0x0004) [0x0000000000000000]              
	class UWwiseEvent*                                 HenchChargeCast;                                  		// 0x0894 (0x0004) [0x0000000000000000]              
	class UWwiseEvent*                                 ChargeImpact;                                     		// 0x0898 (0x0004) [0x0000000000000000]              
	class UWwiseEvent*                                 HenchChargeImpact;                                		// 0x089C (0x0004) [0x0000000000000000]              
	class UWwiseEvent*                                 ChargeTakeoff;                                    		// 0x08A0 (0x0004) [0x0000000000000000]              
	class UWwiseEvent*                                 HenchChargeTakeoff;                               		// 0x08A4 (0x0004) [0x0000000000000000]              
	unsigned long                                      bCachedTargetImpacted : 1;                        		// 0x08A8 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bUseOwnerRotation : 1;                            		// 0x08A8 (0x0004) [0x0000000000000000] [0x00000002] 
	unsigned long                                      bIsInputLocked : 1;                               		// 0x08A8 (0x0004) [0x0000000000002000] [0x00000004] ( CPF_Transient )
	unsigned long                                      bClientCanProcessNoCooldown : 1;                  		// 0x08A8 (0x0004) [0x0000000000002000] [0x00000008] ( CPF_Transient )
	unsigned long                                      bFailedToMoveCaster : 1;                          		// 0x08A8 (0x0004) [0x0000000000000001] [0x00000010] ( CPF_Edit )
	unsigned long                                      bCollectedVolumes : 1;                            		// 0x08A8 (0x0004) [0x0000000000000001] [0x00000020] ( CPF_Edit )
	unsigned long                                      bLineCheckToHead : 1;                             		// 0x08A8 (0x0004) [0x0000000000000000] [0x00000040] 
	unsigned char                                      ClientNoCooldown;                                 		// 0x08AC (0x0001) [0x0000000000002000]              ( CPF_Transient )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 135630 ];
...
UClass* Usfxpowercustomaction_bioticcharge::pClassPointer = NULL;
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 135818 ];
...
UClass* ASFXProjectile_Power_BioticCharge::pClassPointer = NULL;
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 135856 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 135857 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 135877 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 135901 ];
...
UClass* ASFXWeapon_SMG_Shuriken::pClassPointer = NULL;
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 138280 ];
...
UClass* USFXDamageType_SMG_Tempest::pClassPointer = NULL;
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 138283 ];
...
UClass* USFXDamageType_TacticalMachinePistol::pClassPointer = NULL;
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 138286 ];
...
UClass* ASFXWeapon_SMG_Hornet::pClassPointer = NULL;
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 138792 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 138798 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 138804 ];
...
// Class sfxgamecontent.SFXGameEffect_WeaponMod_MagSizeBonus
// 0x0000 (0x0069 - 0x0069)
class USFXGameEffect_WeaponMod_MagSizeBonus : public USFXGameEffect_WeaponMod
{
public:
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 138810 ];
...
UClass* USFXGameEffect_WeaponMod_MagSizeBonus::pClassPointer = NULL;

// Class sfxgamecontent.SFXGameEffect_WeaponMod_NoAmmoUsedChance
// 0x0000 (0x0069 - 0x0069)
class USFXGameEffect_WeaponMod_NoAmmoUsedChance : public USFXGameEffect_WeaponMod
{
public:
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 138814 ];
...
UClass* USFXGameEffect_WeaponMod_NoAmmoUsedChance::pClassPointer = NULL;

// Class sfxgamecontent.sfxgameeffect_weaponmod_weightbonus
// 0x0000 (0x0069 - 0x0069)
class Usfxgameeffect_weaponmod_weightbonus : public USFXGameEffect_WeaponMod
{
public:
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 138818 ];
...
UClass* Usfxgameeffect_weaponmod_weightbonus::pClassPointer = NULL;

// Class sfxgamecontent.SFXGameEffect_WeaponMod_ZoomShakeModifier
// 0x0000 (0x0069 - 0x0069)
class USFXGameEffect_WeaponMod_ZoomShakeModifier : public USFXGameEffect_WeaponMod
{
public:
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 138824 ];
...
UClass* USFXGameEffect_WeaponMod_ZoomShakeModifier::pClassPointer = NULL;
...
{
public:
	struct FString                                     m_sSniperReticleSubMovie;                         		// 0x008C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class UGFxValue*                                   m_oActualReticle;                                 		// 0x0098 (0x0004) [0x0000000000000000]              
	class UGFxValue*                                   m_oZoomText;                                      		// 0x009C (0x0004) [0x0000000000000000]              
	class UGFxValue*                                   m_oDistanceText;                                  		// 0x00A0 (0x0004) [0x0000000000000000]              
	class UGFxValue*                                   m_oAmmoText;                                      		// 0x00A4 (0x0004) [0x0000000000000000]              
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 138828 ];
...
UClass* USFXGUI_StandardSniperZoomReticle::pClassPointer = NULL;

// Class sfxgamecontent.SFXGUI_AssaultRifleZoomReticle
// 0x0000 (0x00A8 - 0x00A8)
class USFXGUI_AssaultRifleZoomReticle : public USFXGUI_StandardSniperZoomReticle
{
public:
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 138849 ];
...
UClass* USFXGUI_AssaultRifleZoomReticle::pClassPointer = NULL;

// Class sfxgamecontent.SFXWeaponMod_SMGAccuracy
// 0x0000 (0x00EE - 0x00EE)
class USFXWeaponMod_SMGAccuracy : public USFXWeaponMod
{
public:
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 138853 ];
...
UClass* USFXWeaponMod_SMGAccuracy::pClassPointer = NULL;

// Class sfxgamecontent.SFXWeaponMod_SMGConstraintDamage
// 0x0000 (0x00EE - 0x00EE)
class USFXWeaponMod_SMGConstraintDamage : public USFXWeaponMod
{
public:
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 138862 ];
...
UClass* USFXWeaponMod_SMGConstraintDamage::pClassPointer = NULL;

// Class sfxgamecontent.SFXWeaponMod_SMGDamage
// 0x0000 (0x00EE - 0x00EE)
class USFXWeaponMod_SMGDamage : public USFXWeaponMod
{
public:
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 138865 ];
...
UClass* USFXWeaponMod_SMGDamage::pClassPointer = NULL;

// Class sfxgamecontent.SFXWeaponMod_SMGMagSize
// 0x0000 (0x00EE - 0x00EE)
class USFXWeaponMod_SMGMagSize : public USFXWeaponMod
{
public:
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 138873 ];
...
UClass* USFXWeaponMod_SMGMagSize::pClassPointer = NULL;

// Class sfxgamecontent.SFXWeaponMod_SMGStability
// 0x0000 (0x00EE - 0x00EE)
class USFXWeaponMod_SMGStability : public USFXWeaponMod
{
public:
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 138876 ];
...
UClass* USFXWeaponMod_SMGStability::pClassPointer = NULL;
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 138991 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 138995 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 138999 ];
...
// Class sfxgamecontent.SFXGameEffect_WeaponMod_StabilityBonus
// 0x0000 (0x0069 - 0x0069)
class USFXGameEffect_WeaponMod_StabilityBonus : public USFXGameEffect_WeaponMod
{
public:
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 139005 ];
...
UClass* USFXGameEffect_WeaponMod_StabilityBonus::pClassPointer = NULL;
